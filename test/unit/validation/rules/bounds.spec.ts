...
describe("validation rule bounds", () => {
	describe("min", () => {
		it("should check numbers", () => {
			const check: RuleCheckFn<any> = min(10).check;
	...
	describe("max", () => {
		it("should check numbers", () => {
			const check: RuleCheckFn<any> = max(10).check;
			expect(check(10, null)).to.be.null;
	...
	describe("minDate", () => {
		it("should check dates", () => {
			...
			const check: RuleCheckFn<any> = minDate(testDate).check;
	...
	describe("maxDate", () => {
		it("should check dates", () => {
			...
			const check: RuleCheckFn<any> = maxDate(testDate).check;
			expect(check(testDate, null)).to.be.null;
	...
	describe("minLength", () => {
		it("should check strings", () => {
			const check: RuleCheckFn<any> = minLength(2).check;
	...
	describe("maxLength", () => {
		it("should check strings", () => {
			const check: RuleCheckFn<any> = maxLength(2).check;
	...
	describe("minSize", () => {
		it("should check arrays", () => {
			const check: RuleCheckFn<any> = minSize(2).check;
	...
	describe("maxSize", () => {
		it("should check arrays", () => {
			const check: RuleCheckFn<any> = maxSize(2).check;
	...
	describe("isIn", () => {
		it("should check against arrays", () => {
			const check: RuleCheckFn<any> = isIn([1, 2, 3]).check;
		...
		it("should check against sets", () => {
			const check: RuleCheckFn<any> = isIn(new Set([1, 2, 3])).check;
			expect(check(1, null)).to.be.null;
			expect(check(0, null)).to.deep.equal({
				isIn: true
			});
		...
		it("should check against enums", () => {
			...
			const check: RuleCheckFn<any> = isIn(TestEnum).check;
