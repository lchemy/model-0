...
describe("validation result", () => {
	it("should initialize properly", () => {
		let result1: ValidationResult = new ValidationResult(null, {
			a: 1
		});
		expect(result1.isValid).to.be.true;

		let result2: ValidationResult = new ValidationResult({
			a: true
		}, {
			a: 1
		});
